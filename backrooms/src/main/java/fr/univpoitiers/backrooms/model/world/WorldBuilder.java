...
public class WorldBuilder {
    ...
    public WorldBuilder() {
        ...
        String pathRealWorld = Objects.requireNonNull(WorldBuilder.class.getResource("/images/levels/level1.png")).toExternalForm();
        String pathLevel1 = Objects.requireNonNull(WorldBuilder.class.getResource("/images/levels/level1.png")).toExternalForm();
        String pathLevel7 = Objects.requireNonNull(WorldBuilder.class.getResource("/images/levels/level1.png")).toExternalForm();
